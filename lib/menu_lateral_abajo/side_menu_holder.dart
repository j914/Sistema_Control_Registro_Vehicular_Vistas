...
import 'package:frontend/pantalla_raiz/root_screen_1.dart';
import 'package:frontend/pantalla_raiz/root_screen_2.dart';
import 'package:frontend/pantalla_raiz/root_screen_3.dart';
import 'package:frontend/pantalla_raiz/root_screen_4.dart';
...
class SideMenuHolder {
  ...
  List<_MenuItem> _menus = [
    _MenuItem(
      name: 'Escanear Vehiculo',
      icon: Icons.add_a_photo,
      isHeader: false,
      rootScreen: RootScreen1(),
    ),
    _MenuItem(
      name: 'Control Registro Admin',
    ...
    if (items.isEmpty) {
      this._menus = [
        ...
        _MenuItem(
          ...
          icon: Icons.star,
          isHeader: false,
          rootScreen: MyHomePage("Vehiculos con reporte de robo"),
        ),
        _MenuItem(
          name: 'RootScreen4',
          icon: Icons.icecream,
