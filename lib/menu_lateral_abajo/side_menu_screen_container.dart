...
class SideMenuScreenContainer extends StatefulWidget {
  @override
  _SideMenuScreenContainerState createState() =>
      _SideMenuScreenContainerState();
}
...
class _SideMenuScreenContainerState extends State<SideMenuScreenContainer> {
    ...
    return // This container to animate the content, to display SideMenu
      ...
      child: AnimatedContainer(
        ...
        child: ClipRRect(
          ...
          borderRadius: SideMenuHolder.shared.isMenuOpened
              ? _borderRadius
              : BorderRadius.zero,
  ...
  Matrix4 _getTransform(BuildContext ctx) {
    ...
    _transform = Matrix4.translationValues(
        width * (SideMenuHolder.shared.isMenuOpened ? 0.4 : 0), 0.0, 0.0);
    return _transform;
  }
